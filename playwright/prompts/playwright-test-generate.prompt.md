...
Use the **Markdown test plan** produced by the planner (default: **`playwright/specs/acme-dashboard.plan.md`**).
...
- Test plan: `playwright/specs/acme-dashboard.plan.md`

**Example request to the generator agent:**  
“Generate tests for scenario **1.1** from `playwright/specs/acme-dashboard.plan.md` using seed `tests/e2e/seed.spec.ts`, save under `tests/e2e/…`.”
